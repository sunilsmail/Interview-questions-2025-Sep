...
Includes inherited properties unless filtered with hasOwnProperty.
...
Iterates values of an iterable (like arrays, strings, sets, maps).

Cannot be used directly on plain objects (unless you use Object.values).
...
Works on Objects	✅ Yes	❌ No (unless Object.values)
Works on Arrays	✅ Yes (indexes as keys)	✅ Yes (direct values)
